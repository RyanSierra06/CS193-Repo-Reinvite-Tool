...
export default function Page() {
  const [organization, setOrganization] = useState<OrganizationKey>("PurdueCS193-F25");
  const [assignment, setAssignment] = useState<string>(() => {
    // Ensure we have a valid assignment on first load
    const firstAssignment = Object.keys(ORGANIZATIONS["PurdueCS193-F25"].assignments)[0];
    return firstAssignment || "Homework-0";
  });
